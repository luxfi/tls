...
var (
	ErrCertificateTooLarge                   = fmt.Errorf("tls: certificate length is greater than %d", MaxCertificateLen)
	ErrMalformedCertificate                  = errors.New("tls: malformed certificate")
	ErrMalformedTBSCertificate               = errors.New("tls: malformed tbs certificate")
	ErrMalformedVersion                      = errors.New("tls: malformed version")
	ErrMalformedSerialNumber                 = errors.New("tls: malformed serial number")
	ErrMalformedSignatureAlgorithmIdentifier = errors.New("tls: malformed signature algorithm identifier")
	ErrMalformedIssuer                       = errors.New("tls: malformed issuer")
	ErrMalformedValidity                     = errors.New("tls: malformed validity")
	ErrMalformedSPKI                         = errors.New("tls: malformed spki")
	ErrMalformedPublicKeyAlgorithmIdentifier = errors.New("tls: malformed public key algorithm identifier")
	ErrMalformedSubjectPublicKey             = errors.New("tls: malformed subject public key")
	ErrMalformedOID                          = errors.New("tls: malformed oid")
	ErrInvalidRSAPublicKey                   = errors.New("tls: invalid RSA public key")
	ErrInvalidRSAModulus                     = errors.New("tls: invalid RSA modulus")
	ErrInvalidRSAPublicExponent              = errors.New("tls: invalid RSA public exponent")
	ErrRSAModulusNotPositive                 = errors.New("tls: RSA modulus is not a positive number")
	ErrUnsupportedRSAModulusBitLen           = errors.New("tls: unsupported RSA modulus bitlen")
	ErrRSAModulusIsEven                      = errors.New("tls: RSA modulus is an even number")
	ErrUnsupportedRSAPublicExponent          = errors.New("tls: unsupported RSA public exponent")
	ErrFailedUnmarshallingEllipticCurvePoint = errors.New("tls: failed to unmarshal elliptic curve point")
